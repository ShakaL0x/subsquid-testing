...
export const functions = {
    ...
    deprecated: fun("0x0e136b19", {}, p.bool),
    ...
    upgradedAddress: fun("0x26976e3f", {}, p.address),
    balances: fun("0x27e235e3", {"_0": p.address}, p.uint256),
    decimals: fun("0x313ce567", {}, p.uint256),
    maximumFee: fun("0x35390714", {}, p.uint256),
    _totalSupply: fun("0x3eaaf86b", {}, p.uint256),
    unpause: fun("0x3f4ba83a", {}, ),
    getBlackListStatus: fun("0x59bf1abe", {"_maker": p.address}, p.bool),
    allowed: fun("0x5c658165", {"_0": p.address, "_1": p.address}, p.uint256),
    paused: fun("0x5c975abb", {}, p.bool),
    balanceOf: fun("0x70a08231", {"who": p.address}, p.uint256),
    ...
    basisPointsRate: fun("0xdd644f72", {}, p.uint256),
    isBlackListed: fun("0xe47d6060", {"_0": p.address}, p.bool),
    removeBlackList: fun("0xe4997dc5", {"_clearedUser": p.address}, ),
    MAX_UINT: fun("0xe5b5019a", {}, p.uint256),
